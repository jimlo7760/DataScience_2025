...
def main():
    """Main execution function to fetch and save raw education data for all cities."""

    print("Fetching Raw ACS Education Data (2014-2023)")
    print("=" * 50)
    ...
    for city_key, (state_fips, place_fips, city_name) in CITIES.items():
        ...
        for year in range(2014, 2024):
            ...
            if data:
                ...
                # Add all education variables with their raw counts
                for var_code, education_level in EDUCATION_VARS.items():
                    try:
                        row[education_level] = int(data.get(var_code, 0))
                    except ValueError:
                        row[education_level] = 0
        ...
        if city_data:
            ...
            filename = f"{city_key}_raw_education_2014_2023.csv"
